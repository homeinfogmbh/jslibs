...
var openimmo = {
	Ausstattung: function(ausstattung_node) {
	    ...
	    this.dv_verkabelung = ausstattung_node.getElementValue(
	        "dv_verkabelung");
	    ...
	    this.brauereibindung = ausstattung_node.getElementValue(
	        "brauereibindung");
	    this.sporteinrichtungen = ausstattung_node.getElementValue(
	        "sporteinrichtungen");
	    this.wellnessbereich = ausstattung_node.getElementValue(
	        "wellnessbereich");
	    ...
	    this.seniorengerecht= ausstattung_node.getElementValue(
	        "seniorengerecht");
	    return this;
	},
	
	
	Flaechen: function(flaechen_node) {
	    ...
	    this.anzahl_schlafzimmer = flaechen_node.getElementValue(
	        "anzahl_schlafzimmer");
	    this.anzahl_badezimmer = flaechen_node.getElementValue(
	        "anzahl_badezimmer");
	    ...
	    this.anzahl_terrassen = flaechen_node.getElementValue(
	        "anzahl_terrassen");
	    ...
	    this.fensterfront_qm = flaechen_node.getElementValue(
	        "fensterfront_qm");
	    this.grundstuecksfront = flaechen_node.getElementValue(
	        "grundstuecksfront");
	    this.dachbodenflaeche = flaechen_node.getElementValue(
	        "dachbodenflaeche");
	    ...
	    this.anzahl_stellplaetze = flaechen_node.getElementValue(
	        "anzahl_stellplaetze");
	    this.plaetze_gastraum = flaechen_node.getElementValue(
	        "plaetze_gastraum");
	    ...
	    this.einliegerwohnung = flaechen_node.getElementValue(
	        "einliegerwohnung");
	...
	Preise: function(preise_node) {
	    ...
	    this.zzg_mehrwertsteuer = preise_node.getElementValue(
	        "zzg_mehrwertsteuer");
	    this.mietzuschlaege = preise_node.getElementValue("mietzuschlaege");
	    this.hauptmietzinsnetto = preise_node.getElementValue(
	        "hauptmietzinsnetto");
	    ...
	    this.gesamtmietenetto = preise_node.getElementValue(
	        "gesamtmietenetto");
	    this.gesamtmietebrutto = preise_node.getElementValue(
	        "gesamtmietebrutto");
	    ...
	    this.sonstigekostennetto = preise_node.getElementValue(
	        "sonstigekostennetto");
	    this.sonstigemietenetto = preise_node.getElementValue(
	        "sonstigemietenetto");
	    ...
	    this.preis_zeitraum_von = preise_node.getElementValue(
	        "preis_zeitraum_von");
	    this.preis_zeitraum_bis = preise_node.getElementValue(
	        "preis_zeitraum_bis");
	    this.preis_zeiteinheit = preise_node.getElementValue(
	        "preis_zeiteinheit");
	    this.mietpreis_pro_qm = preise_node.getElementValue(
	        "mietpreis_pro_qm");
	    this.kaufpreis_pro_qm = preise_node.getElementValue(
	        "kaufpreis_pro_qm");
	    ...
	    this.courtage_hinweis = preise_node.getElementValue(
	        "courtage_hinweis");
	    ...
	    this.nettorendite_soll = preise_node.getElementValue(
	        "nettorendite_soll");
	    this.nettorendite_ist = preise_node.getElementValue(
	        "nettorendite_ist");
	    this.mieteinnahmen_ist = preise_node.getElementValue(
	        "mieteinnahmen_ist");
	    this.mieteinnahmen_soll = preise_node.getElementValue(
	        "mieteinnahmen_soll");
	    ...
	    this.geschaeftsguthaben = preise_node.getElementValue(
	        "geschaeftsguthaben");
	...
	Kontaktperson: function(kontaktperson_node) {
	    this.email_zentrale = kontaktperson_node.getElementValue(
	        "email_zentrale");
	    ...
	    this.email_sonstige = kontaktperson_node.getElementValue(
	        "email_sonstige");
	    this.email_feedback = kontaktperson_node.getElementValue(
	        "email_feedback");
	    ...
	    this.adressfreigabe = kontaktperson_node.getElementValue(
	        "adressfreigabe");
	    this.personennummer = kontaktperson_node.getElementValue(
	        "personennummer");
	...
	Objektkategorie: function(objektkategorie_node) {
	    ...
	    var vermarktungsart = objektkategorie_node.getElement(
	        "vermarktungsart");
	    if (vermarktungsart) {
	...
	ZustandAngaben: function(zustand_angaben) {
	...
	VerwaltungObjekt: function(verwaltung_objekt) {
	...
	VerwaltungTechn: function(verwaltung_techn){
	...
	Immobilie: function(immobilie_node) {
	    function _anhaenge() {
	        var result = [];
	    ...
	    if (zustand_angaben) {
	        this.zustand_angaben = openimmo.ZustandAngaben(zustand_angaben);
	    } else {
	    ...
	    if (verwaltung_objekt) {
	        this.verwaltung_objekt = openimmo.VerwaltungObjekt(
	            verwaltung_objekt);
	    } else {
	    ...
	    if (verwaltung_techn) {
	        this.verwaltung_techn = openimmo.VerwaltungTechn(verwaltung_techn);
	    } else {
	...
	Anbieter: function(anbieter_node) {
	    function _immobilie() {
	        var result = [];
